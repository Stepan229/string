...
START_TEST(sprintf_test_sprintf45) {
  char str1[BUFF_SIZE];
  char str2[BUFF_SIZE];
  char format[] = "%f";
  double hex = INFINITY;
...
START_TEST(sprintf_test_sprintf46) {
  char str1[BUFF_SIZE];
  char str2[BUFF_SIZE];
  char format[] = "%f";
  double hex = -INFINITY;
...
START_TEST(sprintf_test_sprintf47) {
  char str1[BUFF_SIZE];
  char str2[BUFF_SIZE];
  char format[] = "%f";
  double hex = NAN;
...
START_TEST(sprintf_test_sprintf48) {
  char str1[BUFF_SIZE];
  char str2[BUFF_SIZE];
  char format[] = "%F";
  double hex = INFINITY;
...
START_TEST(sprintf_test_sprintf49) {
  char str1[BUFF_SIZE];
  char str2[BUFF_SIZE];
  char format[] = "%F";
  double hex = -INFINITY;
...
START_TEST(sprintf_test_sprintf50) {
  char str1[BUFF_SIZE];
  char str2[BUFF_SIZE];
  char format[] = "%F";
  double hex = NAN;
